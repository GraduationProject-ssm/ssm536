...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=133)
...
第四章：这个章节主要绘制出了系统功能架构，让我们更直观了解马病管理系统的功能，对后台数据库表进行了设计，还画出了对应的Ｅ－Ｒ图。
...
![论坛](/md/blog.008.jpeg "论坛")
图4.1 论坛实体属性图

（2）下图是用户实体和其具备的属性。

![用户](/md/blog.009.jpeg "用户")
图4.2 用户实体属性图
...
![员工](/md/blog.011.jpeg "员工")
图4.4 员工实体属性图

（5）下图是马病实体和其具备的属性。

![马病](/md/blog.012.jpeg "马病")
图4.5 马病实体属性图

（6）下图是马病收藏实体和其具备的属性。

![马病收藏](/md/blog.013.jpeg "马病收藏")
图4.6 马病收藏实体属性图

（7）下图是马病留言实体和其具备的属性。

![马病留言](/md/blog.014.jpeg "马病留言")
图4.7 马病留言实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|mabing\_uuid\_number|String|马病编号|是|
|3|mabing\_name|String|马病名称|是|
|4|mabing\_photo|String|马病照片|是|
|5|mabing\_types|Integer|病因类型|是|
|6|zhengzhuang\_text|String|基本症状|是|
|7|zhiliaofangan\_text|String|治疗方案|是|
|8|yufangfangan\_text|String|预防方案|是|
|9|mabing\_clicknum|Integer|点击次数|是|
|10|shangxia\_types|Integer|是否上架|是|
|11|mabing\_delete|Integer|逻辑删除|是|
|12|mabing\_content|String|马病详细介绍|是|
|13|insert\_time|Date|添加时间|是|
|14|update\_time|Date|最后更新时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|mabing\_id|Integer|马病|是|
|3|yonghu\_id|Integer|用户|是|
|4|mabing\_collection\_types|Integer|类型|是|
...
|2|mabing\_id|Integer|马病|是|
|3|yonghu\_id|Integer|用户|是|
|4|mabing\_liuyan\_text|String|留言内容|是|
...
|4|yuangong\_photo|String|员工头像|是|
